 ...
 * @Last Modified time: 2020-12-26 16:48:02
 */

import { IMobilePhoneDoc, factory } from '../models/mobile-phone.ts';
// import { BaseService } from '../base/base.service.mongo';
import { Model } from '../deps.ts';
// import * as _ from 'lodash';
import { MobilePhoneQuery, MobilePhoneSaveIn, MobilePhoneSaveOut, MobilePhoneModifyIn, MobilePhoneDelIn } from '../schemas/request/mobile-phone.ts';
...
export class MobilePhoneService {
  ...
  constructor() {
    ...
    // console.log('MobilePhoneDoc:', this.MobilePhoneDoc);
  }
  ...
  async save(param: MobilePhoneSaveIn): Promise<MobilePhoneSaveOut> {
    return this.MobilePhoneDoc.create(this.MobilePhoneDoc, param).then(result => {
